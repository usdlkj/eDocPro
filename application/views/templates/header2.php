			...
			<div class="container-fluid">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Project <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<?php foreach ($projects as $project_item) { 
									echo "<li><a href='".site_url(array('document','view',$this->hashids->encode($project_item['project_id'])))."'>".$project_item['project_name']."</a></li>";
								}?>
