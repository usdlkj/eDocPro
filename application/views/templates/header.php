				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<?php if ($project_id != '0'):?><li class="dropdown">
							<a href="<?php echo site_url(array('document','view',$project_id));?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
								<span class="glyphicon glyphicon-file" aria-hidden="true"></span> Document <span class="caret"></span>
							</a>
						...
						<li class="dropdown">
							<a href="<?php echo site_url(array('mail','view',$project_id));?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
								<span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Mail <span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
						...
						<?php endif; if ($is_admin):?><li class="dropdown">
							<a href="<?php echo site_url(array('user','view'));?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
								<span class="glyphicon glyphicon-home" aria-hidden="true"></span> Administration <span class="caret"></span>
							</a>
							<ul class="dropdown-menu">
			...
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						<?php foreach ($projects as $project_item):?><?php 
							echo '<li'; 
							if ($project_id != '0') {
							...
							echo '><a href="'.site_url(array('document','view',$this->hashids->encode($project_item['project_id']))).'">'.$project_item['project_name'].'</a></li>';?>
