							...
							<?php foreach ($fields as $field):?><tr>
								<td class="text-center">
									...
									<?php if ($field['field_type'] == 5 || $field['field_type'] == 6):?><a href="<?php echo site_url(array('selectvalue','view',$field_id_hash));?>" data-toggle="tooltip" title="Selections">
										<button type="button" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-file" aria-hidden="true"></span></button>
									</a>
									<?php else:?><button type='button' class='btn btn-xs'><span class='glyphicon glyphicon-file' aria-hidden='true'></span></button><?php endif;?>
